...
//        edt_search.imeOptions = EditorInfo.IME_ACTION_DONE
    ...
    private fun getMyCollects(){
        ...
        collects.add(MyCollection("PIZZA", "https://images.unsplash.com/photo-1601924582970-9238bcb495d9?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=400&fit=max"))
        collects.add(MyCollection("Ice cream","https://images.unsplash.com/photo-1560008581-09826d1de69e?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=400&fit=max"))
        collects.add(MyCollection("Coffee Culture ☕ ", "https://images.unsplash.com/photo-1567016530961-54fd42f2d51f?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=400&fit=max"))
        collects.add(MyCollection("health", "https://images.unsplash.com/photo-1553531889-65d9c41c2609?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=400&fit=max"))
        collects.add(MyCollection("New Year", "https://images.unsplash.com/photo-1514446945-952d86c3449b?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=400&fit=max"))
        collects.add(MyCollection("Work from Anywhere", "https://images.unsplash.com/photo-1584677626646-7c8f83690304?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=400&fit=max"))
    ...
    private fun getCollections(){
        RetrofitHttp.photosService.getCollections().enqueue(object : Callback<ArrayList<Collection>>{
